...
const RestaurantOwnerRegister = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('http://localhost:8093/api/v1/auth/register/restaurantOwner', formData);
          ...
          <Col md={8} lg={6}>
            <Card className="shadow-lg border-0">
              <Card.Body className="p-5">
                <h2 className="text-center mb-4" style={{ color: '#ff6b6b' }}>Restaurant Owner Registration</h2>
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Form.Group className="mb-3">
                    <Form.Label className="text-muted fw-bold">Restaurant Name</Form.Label>
                    <Form.Control
                      type="text"
                      name="restaurantName"
                  ...
                  <Form.Group className="mb-3">
                    <Form.Label className="text-muted fw-bold">Restaurant Pin</Form.Label>
                    <Form.Control
                      type="text"
                      name="restaurantPin"
                      value={formData.restaurantPin}
                      onChange={handleChange}
                      required
                      className="py-2"
                      style={{ backgroundColor: '#f8f9fa', border: '2px solid #eee' }}
                  ...
                  <Form.Group className="mb-4">
                    <Form.Label className="text-muted fw-bold">Restaurant Location</Form.Label>
                    <Form.Control
                      type="text"
