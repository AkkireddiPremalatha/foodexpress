...
import { List, PencilSquare, Trash, House, ClockHistory, CheckCircle, PlusCircle, Grid } from 'react-bootstrap-icons';
      ...
      >
        ...
        <Offcanvas.Body>
          <div className="d-grid gap-3">
            ...
            >
              <PlusCircle className="me-2" />Add Menu Items
            </Button>
            <Button
              variant="outline-danger"
              size="lg"
